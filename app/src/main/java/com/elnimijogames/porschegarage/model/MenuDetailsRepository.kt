...
class MenuDetailsRepository @Inject constructor(private val stringResourceProvider: StringResourceProvider) {
    ...
    fun getDetailsImagePath(menuId: String): String {
        when (menuId) {
            MenuId.MENU_ID_SUMMARY -> return "file:///android_asset/images/cars/porsche13.jpg"
            MenuId.MENU_ID_HIGHLIGHTS -> return "file:///android_asset/images/cars/porsche11.jpg"
            MenuId.MENU_ID_INTERIOR -> return "file:///android_asset/images/cars/porsche18.jpg"
            MenuId.MENU_ID_EXTERIOR -> return "file:///android_asset/images/cars/porsche24.jpg"
            MenuId.MENU_ID_EXPERIENCE -> return "file:///android_asset/images/cars/porsche9.jpg"
            MenuId.MENU_ID_TECHNOLOGY -> return "file:///android_asset/images/cars/porsche22.jpg"
            MenuId.MENU_ID_VIDEOS -> return "file:///android_asset/images/cars/porsche7.jpg"
            MenuId.MENU_ID_ABOUT -> return "file:///android_asset/images/cars/porsche16.jpg"
        }
    ...
    fun getDetailsTextDetails(menuId: String): AnnotatedString {
        when (menuId) {
            MenuId.MENU_ID_SUMMARY -> return getSummaryTextDetails()
            MenuId.MENU_ID_HIGHLIGHTS -> return getHighlightsTextDetails()
            MenuId.MENU_ID_INTERIOR -> return getInteriorTextDetails()
            MenuId.MENU_ID_EXTERIOR -> return getExteriorTextDetails()
            MenuId.MENU_ID_EXPERIENCE -> return getExperienceTextDetails()
            MenuId.MENU_ID_TECHNOLOGY -> return getTechnologyTextDetails()
            MenuId.MENU_ID_VIDEOS -> return getVideosTextDetails()
            MenuId.MENU_ID_ABOUT -> return getAboutTextDetails()
        }
